...
# JBV - Adding useful gems for ALL environments
...
group :development do
  gem "better_errors"       # Nicer display of errors within the Rails env
  gem "binding_of_caller"   # Rake middleware needed by "better_errors"
end

# JBV - Commented the call to "turbolinks" as it causes buggy behavior with Bootstrap javascript (ex. navbar dropdown)
